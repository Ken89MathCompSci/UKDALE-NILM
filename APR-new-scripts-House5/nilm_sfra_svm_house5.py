"""
nilm_sfra_svm_house5.py
========================
SVM baseline for NILM on APR-new-House5-dataset (House 5, Jul-Sep 2014).
...
(same train-locked convention as combined_pinn_lnn_apr_new_house5_dataset.py).
...
# ---------------------------------------------------------------------------
# Feature extraction  (identical to combined_pinn_lnn_apr_new_house5_dataset.py)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Adaptive thresholds  (identical to combined_pinn_lnn_apr_new_house5_dataset.py)
# ---------------------------------------------------------------------------
...
def load_data(dataset_dir: str) -> dict:
    print(f"Loading APR-new-House5-dataset from '{dataset_dir}' ...")
...
def main(dataset_dir: str = DEFAULT_DATASET_DIR, tune: bool = False,
    ...
    out_path  = os.path.join(dataset_dir, f'svm_house5_results_{timestamp}.json')
