"""
Liquid Neural Network (LNN) baseline for NILM -- APR-new-House5-dataset/ splits.

Derived from Old-LNN_Algorithms/test_lnn_ukdale_specific_splits.py with the same
three changes described in test_gru_apr_new_house5_dataset.py:
...
def train_on_appliance(data_dict, appliance_name, window_size=100,
                        ...
                        save_dir='models/lnn_apr_new_house5_dataset'):
    ...
    for epoch in range(epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            best_model_path = os.path.join(
                save_dir, f"lnn_apr_new_house5_{appliance_name}_best.pth")
            save_model(model,
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(save_dir, f"lnn_apr_new_house5_{appliance_name}_metrics.png"),
    ...
    with open(os.path.join(save_dir, f'lnn_apr_new_house5_{appliance_name}_history.json'),
...
def test_on_all_appliances(window_size=100, hidden_size=64, dt=0.1,
    ...
    base_save_dir = os.path.join(
        os.path.dirname(__file__), '..', 'models', f"lnn_apr_new_house5_dataset_{timestamp}")
            ...
            if model is not None:
                all_results[appliance_name] = {
                    'model_path': os.path.join(
                        appliance_dir, f"lnn_apr_new_house5_{appliance_name}_best.pth"),
    ...
    print(f"\nLiquidNetworkModel APR-new-House5-dataset testing completed. "
...
if __name__ == "__main__":
    print("Testing LiquidNetworkModel on APR-new-House5-dataset...")
    ...
    print(f"\nSummary of LiquidNetworkModel testing on APR-new-House5-dataset:")
