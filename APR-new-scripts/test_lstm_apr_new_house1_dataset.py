"""
LSTM baseline for NILM -- APR-new-House1-dataset/ splits.
...
def train_lstm_on_appliance(data_dict, appliance_name, window_size=100,
                             ...
                             save_dir='models/lstm_apr_new_house1_dataset'):
    ...
    for epoch in range(epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            best_model_path = os.path.join(
                save_dir, f"lstm_apr_new_house1_{appliance_name}_best.pth")
            save_model(model,
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(save_dir, f"lstm_apr_new_house1_{appliance_name}_metrics.png"),
    ...
    with open(os.path.join(save_dir, f'lstm_apr_new_house1_{appliance_name}_history.json'),
...
def test_lstm_on_all_appliances(window_size=100, hidden_size=128, num_layers=2,
    ...
    base_save_dir = os.path.join(
        os.path.dirname(__file__), '..', 'models', f"lstm_apr_new_house1_dataset_{timestamp}")
            ...
            if model is not None:
                all_results[appliance_name] = {
                    'model_path': os.path.join(
                        appliance_dir, f"lstm_apr_new_house1_{appliance_name}_best.pth"),
    ...
    print(f"\nLSTM APR-new-House1-dataset testing completed. Results saved to {base_save_dir}")
...
if __name__ == "__main__":
    print("Testing LSTM on APR-new-House1-dataset...")
    ...
    print(f"\nSummary of LSTM testing on APR-new-House1-dataset:")
