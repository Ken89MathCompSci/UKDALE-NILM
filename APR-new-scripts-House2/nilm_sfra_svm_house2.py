...
========================
SVM baseline for NILM on APR-new-House2-dataset (House 2, Jul 2013).
...
(same train-locked convention as combined_pinn_lnn_apr_new_house2_dataset_v2.py).
...
# ---------------------------------------------------------------------------
# Feature extraction  (identical to combined_pinn_lnn_apr_new_house2_dataset_v2.py)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Adaptive thresholds  (identical to combined_pinn_lnn_apr_new_house2_dataset_v2.py)
# ---------------------------------------------------------------------------
...
def load_data(dataset_dir: str) -> dict:
    print(f"Loading APR-new-House2-dataset from '{dataset_dir}' ...")
...
def main(dataset_dir: str = DEFAULT_DATASET_DIR, tune: bool = False,
    ...
    out_path  = os.path.join(dataset_dir, f'svm_house2_results_{timestamp}.json')
